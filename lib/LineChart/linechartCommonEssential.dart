...
class linechartCommonEssential extends StatefulWidget {


  linechartCommonEssential(
      {Key key})
      : super(key: key);
...
class _LineChartState extends State<linechartCommonEssential> {
  ...
  Future<List<dynamic>> _fetchMainMenu() async {
    ...
    try {
      ...
      if (connectivityResult == ConnectivityResult.mobile ||
        ...
        Response response =
            await ioClient.post(COMMAN_ESSENTAIL, headers: headers, body: formData);
                            ...
                            children: [
                              Row(
                                ...
                                children: <Widget>[
                                  ...
                                  const Text(
                                    'State Wise Demand & Procurement Status',
                                    style: TextStyle(
